...
import voidpointer.mc.tests.AbstractProduct
...
class ProductModelTest {
    ...
    @Test
    fun testEquality() {
        val product: AbstractProduct = ProductModel(1, "name", "description", 2.0, 3, 4)
        val productView: AbstractProduct = ProductView(1, "name", 2.0)
